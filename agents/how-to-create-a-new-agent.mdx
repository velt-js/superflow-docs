...
description: "Learn how to create a new agent in Superflow."
...
<Steps>
  <Step title="On the Superflow Dashboard, click Agents in the left sidebar">
    ...
    <Frame>
    ![On the Superflow Dashboard, click Agents in the left sidebar](/images/how-to-guides/how-to-create-a-new-agent/01-agents-new-agent.png)
    </Frame>
  </Step>
  <Step title="The Basics step will appear">
    ...
    <Frame>
    ![The Basics step will appear](/images/how-to-guides/how-to-create-a-new-agent/02-basics.png)
    </Frame>
  ...
  <Step title="The Prompt step will appear">
    ...
    <Frame>
    ![The Prompt step will appear](/images/how-to-guides/how-to-create-a-new-agent/03-prompt.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="The Test step will begin automatically">
    ...
    <Frame>
    ![The Test step will begin automatically](/images/how-to-guides/how-to-create-a-new-agent/04-testing.png)
    </Frame>
  </Step>
  <Step title="When testing completes, the generated scenarios are listed as numbered tabs">
    ...
    <Frame>
    ![When testing completes, the generated scenarios are listed as numbered tabs](/images/how-to-guides/how-to-create-a-new-agent/05-test-results.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="If a scenario's result looks wrong, click Wrong Output?">
    ...
    <Frame>
    ![If a scenario's result looks wrong, click Wrong Output?](/images/how-to-guides/how-to-create-a-new-agent/06-feedback.png)
    </Frame>
  </Step>
  <Step title="Once you are satisfied with the results, click Create">
    ...
    <Frame>
    ![Once you are satisfied with the results, click Create](/images/how-to-guides/how-to-create-a-new-agent/07-creating.png)
    </Frame>
  </Step>
  <Step title="Your new agent will appear in the All Agents list, marked with a NEW badge">
    <Frame>
    ![Your new agent will appear in the All Agents list, marked with a NEW badge](/images/how-to-guides/how-to-create-a-new-agent/09-agent-list.png)
    </Frame>
  </Step>
</Steps>
