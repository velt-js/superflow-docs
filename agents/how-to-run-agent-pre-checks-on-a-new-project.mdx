...
<Steps>
  <Step title="Click Start">
    Superflow continues to the usual **Install** step, where you copy the script onto your site — but a live preview of your website now loads on the right, and the agents begin running against it at the same time. Expand **Reviewing your website** to watch their progress.
