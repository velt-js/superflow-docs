...
<Steps>
  <Step title="On the Superflow Dashboard, click Agents in the left sidebar">
    ...
    <Frame>
    ![The All Agents page with the Workspace Agent pinned at the top of the list](/images/agents/workspace-agent/01-agents-list.png)
    </Frame>
  </Step>
  <Step title="Click the Workspace Agent to open its checklist">
    ...
    <Frame>
    ![The Workspace Agent checklist page with the Add Rule button](/images/agents/workspace-agent/02-checklist.png)
    </Frame>
  </Step>
</Steps>
