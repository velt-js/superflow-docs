---
title: "How to Create and Run an Agent Group"
description: "Learn how to bundle several agents into a group and run them together against a project."
icon: "layer-group"
---
...
<Steps>
  <Step title="On the Superflow Dashboard, click Agents in the left sidebar to open the All Agents page">
    ...
    <Frame>
    ![On the Superflow Dashboard, click Agents in the left sidebar to open the All Agents page](/images/how-to-guides/how-to-create-and-run-an-agent-group/01-new-group.png)
    </Frame>
  </Step>
  <Step title="The Create Agent Group dialog will appear">
    ...
    <Frame>
    ![The Create Agent Group dialog will appear](/images/how-to-guides/how-to-create-and-run-an-agent-group/02-create-group.png)
    </Frame>
  </Step>
  <Step title="The group is created and opens straight away, showing only the agents it contains">
    ...
    <Frame>
    ![The group is created and opens straight away, showing only the agents it contains](/images/how-to-guides/how-to-create-and-run-an-agent-group/03-group-created.png)
    </Frame>
...
<Steps>
  <Step title="With the group open, click Run All Agents">
    ...
    <Frame>
    ![With the group open, click Run All Agents](/images/how-to-guides/how-to-create-and-run-an-agent-group/04-run-group.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Every agent in the group starts at once, and each row shows a running status while it works">
    ...
    <Frame>
    ![Every agent in the group starts at once, and each row shows a running status while it works](/images/how-to-guides/how-to-create-and-run-an-agent-group/05-progress.png)
    </Frame>
  </Step>
</Steps>
