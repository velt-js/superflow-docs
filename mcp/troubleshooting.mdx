...
<AccordionGroup>
  ...
  <Accordion title="A tool returns a permission error">
    You didn't grant that scope. Each capability is a separate scope on the
    consent screen: running agents, creating projects, reading analytics, and
    inviting people. Reconnect the server and approve the scopes you need.
