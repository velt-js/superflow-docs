...
ChatGPT decides when to call a connector, and it may ask you to confirm the first call in a conversation. If it doesn't reach for Superflow on its own, name it directly, as in *"using Superflow, run the broken links agent on acme.com"*.
