...
description: "Install Superflow on Angular, with a video walkthrough and step-by-step screenshots."
icon: "angular"
---

<Frame caption="Watch the full Angular walkthrough">
  <iframe
    className="w-full aspect-video rounded-xl"
    src="https://www.youtube.com/embed/bXMFHxQLpCo?si=5A53wLD1F7QtLJRl"
    title="Install Superflow on Angular"
    frameBorder="0"
...
<Steps>
  <Step title="Enter Your Site URL">
    ...
    <Frame>
    ![Angular: Enter Your Site URL](/images/enter-url-final.png)
    </Frame>
  </Step>
  <Step title="Select NPM from the list of Platforms">
    ...
    <Frame>
    ![Angular: Select NPM from the list of Platforms](/images/select-npm-final.png)
    </Frame>
  </Step>
  <Step title="Copy your unique Superflow Code">
    ...
    <Frame>
    ![Angular: Copy your unique Superflow Code](/images/copy-npm-final.png)
    </Frame>
  </Step>
  ...
  <Step title="Import Superflow into main.ts">
  ...
  <Step title="Initialize Superflow in main.ts">
  ...
  <Step title="Verify your Installation">
    ...
    <Frame>
    ![Angular: Verify your Installation](/images/verify-final.png)
    </Frame>

    If successful, you should be redirected to your published Angular site and see the following success message:

    <Frame>
    ![Angular: Verify your Installation](/images/verified-final.png)
    </Frame>
  </Step>
  ...
  <Step title="Navigate to your Angular site">
  ...
  <Step title="Test out Superflow">
    ...
    <Frame>
    ![Angular: Test out Superflow](/images/toolbar-final.png)
    </Frame>
  </Step>
  <Step title="Dropping your first comment">
    ...
    <Frame>
    ![Angular: Dropping your first comment](/images/demo.gif)
    </Frame>
  </Step>
</Steps>
